...
class DividendServiceTest {
        ...
        void getDividendStats_Success() {
                ...
                when(dividendsApi.getDividendStats(taxYear))
                                .thenReturn(Mono.just(backendStats));

                // Act & Assert
                StepVerifier.create(dividendService.getDividendStats(taxYear))
                                .assertNext(stats -> {
                ...
                verify(dividendsApi).getDividendStats(taxYear);
        }
        ...
        void getDividendHistory_Success() {
                ...
                when(dividendsApi.listDividends(eq(0), eq(10), any(), any(), any()))
                ...
                // Act & Assert
                StepVerifier.create(dividendService.getDividendHistory(0, 10))
                                .assertNext(history -> {
        ...
        void parseDividendStatement_Success() {
                ...
                when(dividendsApi.bulkImportDividends(any()))
                ...
                verify(dividendStatementsApi).uploadDividendStatement(
                                anyString(), any(), any(), any());
                verify(dividendsApi).bulkImportDividends(any());
        }
        ...
        void parseDividendStatement_BackendStatementError() {
                ...
                when(parsingApi.parseDocument(any(), any())).thenReturn(Mono.just(agentResponse));
                when(dividendStatementsApi.uploadDividendStatement(any(), any(), any(), any()))
                                .thenReturn(Mono.error(new RuntimeException("Backend error")));
        ...
        void parseDividendStatement_EmptyAgentResponse() {
                ...
                verify(dividendsApi, never()).bulkImportDividends(any());
        }
        ...
        void parseDividendStatement_CalculateWithholdingRate() {
                ...
                when(dividendsApi.bulkImportDividends(argThat(request -> {
