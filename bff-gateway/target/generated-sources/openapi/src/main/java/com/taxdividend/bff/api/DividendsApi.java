...
import com.taxdividend.bff.model.GenerateTaxForms200Response;
...
public interface DividendsApi {
    ...
    /**
     * POST /dividends/generate-forms : Generate tax forms
     *
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Forms generated", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = GenerateTaxForms200Response.class))
            })
        },
        security = {
    ...
    @RequestMapping(
        ...
        value = "/dividends/generate-forms",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    
    default Mono<ResponseEntity<GenerateTaxForms200Response>> generateTaxForms(
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = "/dividends/parse",
        produces = { "application/json" },
        consumes = { "multipart/form-data" }
    )
    
    default Mono<ResponseEntity<ParsePDFResponse>> parseDividendPDF(
        @Parameter(name = "file", description = "") @RequestPart(value = "file", required = false) Flux<Part> file,
        @Parameter(hidden = true) final ServerWebExchange exchange
    ) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
