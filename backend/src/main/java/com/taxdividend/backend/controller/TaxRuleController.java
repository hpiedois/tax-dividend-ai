...
public class TaxRuleController implements TaxRulesApi {
         ...
         */
        @Override
        public ResponseEntity<List<TaxRuleDto>> getAllTaxRules(
                ...
                List<TaxRuleDto> rules = taxRuleService.getAllTaxRules(
                                sourceCountry,
                                residenceCountry,
                                active,
                                reliefAtSource,
         ...
         */
        @Override
        public ResponseEntity<TaxRuleDto> getTaxRule(UUID id) {
         ...
         */
        @Override
        public ResponseEntity<TaxRuleDto> findApplicableRule(
                        String sourceCountry,
                        String residenceCountry,
                        String securityType,
                        LocalDate date) {
         ...
         */
        @Override
        public ResponseEntity<TreatyRateResponseDto> getTreatyRate(
                        String sourceCountry,
                        String residenceCountry,
                        String securityType,
                        LocalDate date) {
