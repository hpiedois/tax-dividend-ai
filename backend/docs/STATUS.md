...
3. ✅ Import `FormGenerationRequestDto` corrigé (`api.dto` au lieu de `model`)
...
- ✅ Corrigé `GenerateFormRequest` → `FormGenerationRequestDto` (nom correct du DTO API)
...
- ✅ Corrigé `GenerateFormRequest` → `FormGenerationRequestDto`
