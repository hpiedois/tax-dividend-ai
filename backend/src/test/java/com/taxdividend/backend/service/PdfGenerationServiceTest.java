...
class PdfGenerationServiceTest {
    ...
    void shouldGenerateForm5000Successfully() {
        ...
        when(storageService.uploadFile(any(InputStream.class), anyString(), anyString(), anyString()))
    ...
    void shouldThrowExceptionWhenUserDataIncomplete() {
        ...
        // When/Then
        assertThatThrownBy(() ->
                pdfGenerationService.generateForm5000(incompleteUser, 2024))
                .isInstanceOf(PdfGenerationException.class)
                .hasMessageContaining("User data incomplete");
    }
    ...
    void shouldThrowExceptionWhenDividendListEmpty() {
        ...
        // When/Then
        assertThatThrownBy(() ->
                pdfGenerationService.generateForm5001(testUser, emptyList, 2024))
                .isInstanceOf(PdfGenerationException.class)
    ...
    void shouldThrowExceptionWhenUserNotFound() {
        ...
        // When/Then
        assertThatThrownBy(() ->
                pdfGenerationService.generateForms(request))
                .isInstanceOf(PdfGenerationException.class)
    ...
    void shouldThrowExceptionWhenFormNotFoundForRegeneration() {
        ...
        // When/Then
        assertThatThrownBy(() ->
                pdfGenerationService.regenerateForm(nonExistentFormId))
                .isInstanceOf(PdfGenerationException.class)
