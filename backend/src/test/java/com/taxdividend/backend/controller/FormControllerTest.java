...
class FormControllerTest {
        ...
        void shouldListUserForms() throws Exception {
                // Given
                com.taxdividend.backend.api.dto.GeneratedFormDto formDto = new com.taxdividend.backend.api.dto.GeneratedFormDto();
        ...
        void shouldDownloadForm() throws Exception {
                ...
                org.springframework.core.io.Resource resource = new org.springframework.core.io.ByteArrayResource(
                                fileBytes);
                org.springframework.http.ResponseEntity<org.springframework.core.io.Resource> response = org.springframework.http.ResponseEntity
                                .ok()
