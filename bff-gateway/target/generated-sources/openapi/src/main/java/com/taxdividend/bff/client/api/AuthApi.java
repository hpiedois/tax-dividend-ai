...
public class AuthApi {
     ...
     */
    private ResponseSpec registerUserRequestCreation(@jakarta.annotation.Nonnull RegisterUserRequest registerUserRequest) throws WebClientResponseException {
        Object postBody = registerUserRequest;
        // verify the required parameter 'registerUserRequest' is set
        if (registerUserRequest == null) {
            throw new WebClientResponseException("Missing the required parameter 'registerUserRequest' when calling registerUser", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<RegisterUser200Response> registerUser(@jakarta.annotation.Nonnull RegisterUserRequest registerUserRequest) throws WebClientResponseException {
        ParameterizedTypeReference<RegisterUser200Response> localVarReturnType = new ParameterizedTypeReference<RegisterUser200Response>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<RegisterUser200Response>> registerUserWithHttpInfo(@jakarta.annotation.Nonnull RegisterUserRequest registerUserRequest) throws WebClientResponseException {
        ParameterizedTypeReference<RegisterUser200Response> localVarReturnType = new ParameterizedTypeReference<RegisterUser200Response>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec registerUserWithResponseSpec(@jakarta.annotation.Nonnull RegisterUserRequest registerUserRequest) throws WebClientResponseException {
     ...
     * Verify user email
     * 
     * <p><b>200</b> - Email verified successfully
     * <p><b>400</b> - Invalid token
     * @param token The token parameter
     * @return VerifyEmailResponseDTO
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec verifyEmailRequestCreation(@jakarta.annotation.Nonnull String token) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<VerifyEmailResponseDTO> localVarReturnType = new ParameterizedTypeReference<VerifyEmailResponseDTO>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<VerifyEmailResponseDTO> verifyEmail(@jakarta.annotation.Nonnull String token) throws WebClientResponseException {
        ParameterizedTypeReference<VerifyEmailResponseDTO> localVarReturnType = new ParameterizedTypeReference<VerifyEmailResponseDTO>() {};
     ...
     * <p><b>400</b> - Invalid token
     * @param token The token parameter
     * @return ResponseEntity&lt;VerifyEmailResponseDTO&gt;
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<VerifyEmailResponseDTO>> verifyEmailWithHttpInfo(@jakarta.annotation.Nonnull String token) throws WebClientResponseException {
        ParameterizedTypeReference<VerifyEmailResponseDTO> localVarReturnType = new ParameterizedTypeReference<VerifyEmailResponseDTO>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec verifyEmailWithResponseSpec(@jakarta.annotation.Nonnull String token) throws WebClientResponseException {
